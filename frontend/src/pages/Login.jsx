    ...
    <div className="min-h-screen bg-surface flex font-body">
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-12 bg-surface-container-low border-r border-outline-variant/20">
        ...
        <div>
          ...
          <div className="mt-6 inline-flex items-center gap-2 text-[10px] text-on-surface-variant tracking-widest uppercase border border-outline-variant/30 px-3 py-1.5 rounded-full">
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md bg-surface-container rounded-2xl p-8 border border-outline-variant/20">
          <h2 className="font-headline font-bold text-2xl text-on-surface mb-1">Welcome back</h2>
          <p className="text-xs text-on-surface-variant mb-8">
            Access your development dashboard.
          </p>

          {error && (
            <div className="mb-4 p-3 rounded-lg bg-error/10 border border-error/20 text-xs text-error">
              {error}
            </div>
          )}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-surface-container-low border border-outline-variant/20 rounded-lg pl-8 pr-4 py-2.5 text-xs text-on-surface placeholder:text-on-surface-variant focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary"
                />
              </div>
            </div>
          ...
          {/* Google */}
          <button className="w-full flex items-center justify-center gap-2 py-2.5 rounded-lg bg-surface-container border border-outline-variant/20 text-xs font-medium text-on-surface hover:bg-surface-container-high transition-colors">
